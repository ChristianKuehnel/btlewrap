...
class GatttoolBackend(AbstractBackend):
    ...
    def write_handle(self, handle, value):
        ...
        while attempt <= self.retries:
            cmd = "gatttool --device={} -t {} --char-write-req -a {} -n {} --adapter={}".format(
    ...
    def wait_for_notification(self, handle, delegate, notification_timeout):
        ...
        while attempt <= self.retries:
            cmd = "gatttool --device={} -t {} --char-write-req -a {} -n {} --adapter={} --listen".format(
    ...
    def read_handle(self, handle):
        ...
        while attempt <= self.retries:
            cmd = "gatttool --device={} -t {} --char-read -a {} --adapter={}".format(
